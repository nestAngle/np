    ...
    try:
        ...
        if op.type == 5:
            ...
            if settings["autoAdd"] == True:
                ...
                cl.sendMessage(op.param1, "よお！{} 追加ありがとう！".format(str(contact.displayName)))
            ...
            if msg.contentType == 0:
                ...
                if settings['limit'][sender]['text']['react'] == True:
                    ...
                    if text.lower() == 'help':
                        ...
                        cl.sendMessage(to, "ろ")
                        time.sleep(1.0)
                        cl.sendMessage(to, "ぴょん♪")
                        time.sleep(0.5)
                        cl.sendMessage(to, "ぴょん♪")
                        time.sleep(2.0)
                        cl.sendMessage(to, "…息が切れました。歌ったのは例のあの曲です。わかるよね？")
                        ...
                        for mention in mentionees:
                            if clMID in mention["M"]:
                                if settings["detectMention"] == True:
                                    ...
                                    time.sleep(0.5)
                                    cl.sendContact(op.param1, "u67acbba40f5d7983bd60c200e92456e9")
                                break
        if op.type == 55:
            print ("[ 55 ] 通知讀取消息")
            try:
