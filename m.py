...
botStart = time.time()
cl = LINE("newnegiel@sute.jp", "Towas0328")
            ...
            if msg.contentType == 0:
                ...
                if settings['limit'][sender]['text']['react'] == True:
                    ...
                    if text.lower() == 'help':
                    	...
                    	cl.sendMessage(to,"残念！大凶です！↓↓↓にスタンプを押すとマシになる！")
                    	cl.sendMessage(to,"ハートスタンプ押して♡()\nline://home/post?userMid=u6f2f2f6d6c9ac00ec9e0e036cd4f5e5a&postId=1152678781509014248")
